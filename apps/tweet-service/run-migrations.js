...
async function runMigrations() {
  console.log('🔄 Running tweet-service migrations...');
  ...
  return new Promise((resolve, reject) => {
    ...
    exec(command, { cwd: __dirname }, (error, stdout, stderr) => {
      ...
      console.log('✅ Tweet service migrations completed successfully');
      console.log(stdout);
      resolve();
    });
  });
...
async function main() {
  try {
    ...
    await runMigrations();
    console.log('🎉 All tweet-service migrations completed!');
  } catch (error) {
